...
BetterModel is a Rails engine gem (Rails 8.1+) that extends ActiveRecord model functionality. The gem is currently at version 3.0.1 and follows the standard Rails engine architecture.
