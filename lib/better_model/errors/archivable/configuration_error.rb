...
module BetterModel
  module Errors
    module Archivable
      # Configuration error for Archivable module.
      # Inherits from ArgumentError to ensure consistency with standard Ruby error handling.
      #
      # @example
      #   raise ConfigurationError.new(
      #     reason: "Archivable can only be included in ActiveRecord models",
      #     model_class: MyClass
      #   )
      #
      # @example Accessing error data
      #   rescue ConfigurationError => e
      #     e.reason        # => "Archivable can only be included..."
      #     e.model_class   # => MyClass
      #
      #     # Sentry-compatible data
      #     e.tags    # => {error_category: 'configuration', module: 'archivable'}
