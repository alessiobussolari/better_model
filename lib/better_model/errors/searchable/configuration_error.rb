...
module BetterModel
  module Errors
    module Searchable
      ...
      #     reason: "Searchable can only be included in ActiveRecord models",
      #     model_class: MyClass
      #   )
      #
      # @example Accessing error data
      #   rescue ConfigurationError => e
      #     e.reason        # => "Searchable can only be included..."
      #     e.model_class   # => MyClass
      #
      #     # Sentry-compatible data
      #     e.tags    # => {error_category: 'configuration', module: 'searchable'}
