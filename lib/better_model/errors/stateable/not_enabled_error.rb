...
module BetterModel
  module Errors
    module Stateable
      # Raised when Stateable methods are called but the module is not enabled on the model.
      #
      # @example
