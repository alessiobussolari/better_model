...
module BetterModel
  module Errors
    module Validatable
      # Configuration error for Validatable module.
      # Inherits from ArgumentError to ensure consistency with standard Ruby error handling.
      #
      # @example
      #   raise ConfigurationError.new(
      #     reason: "Validatable can only be included in ActiveRecord models",
      #     model_class: MyClass
      #   )
      #
      # @example Accessing error data
      #   rescue ConfigurationError => e
      #     e.reason        # => "Validatable can only be included..."
      #     e.model_class   # => MyClass
      #
      #     # Sentry-compatible data
      #     e.tags    # => {error_category: 'configuration', module: 'validatable'}
